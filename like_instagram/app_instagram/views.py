...
def main(request):
    return render(request, "app_instagram/index.html", context={"title": "Study django GoIT WEB10"})
...
def upload(request):
    ...
    return render(request, "app_instagram/upload.html", context={"title": "Study django GoIT WEB10", "form": form})
...
def pictures(request):
    ...
    return render(request,
                  ...
                  context={"title": "Study django GoIT WEB10", "pictures": pictures, "media": settings.MEDIA_URL})
...
def edit(request, pic_id):
    ...
    return render(request,
                  ...
                  context={"title": "Study django GoIT WEB10", "pic": picture, "media": settings.MEDIA_URL})